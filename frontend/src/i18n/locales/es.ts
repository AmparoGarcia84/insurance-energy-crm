export default {
  ...
  cases: {
    ...
    new:   'Nuevo caso',
    edit:  'Editar caso',
    search: 'Buscar por cliente, nombre o descripción...',
    ...
    columns: {
      ...
      status:      'Fase',
      priority:    'Prioridad',
      occurrenceAt: 'Fecha de ocurrencia',
    ...
    sections: {
      main:        'Datos del caso',
      description: 'Descripción y causa',
    },
    fields: {
      ...
      clientLoading:     'Cargando clientes...',
      sale:              'Venta asociada',
      salePlaceholder:   '— Seleccionar venta —',
      saleNone:          'Sin venta asociada',
      name:              'Nombre del caso',
      occurrenceAt:      'Fecha y hora de ocurrencia',
      description:       'Descripción',
      cause:             'Causa',
      type:              'Tipo',
  ...
  suppliers: {
    ...
    search: 'Buscar por nombre, CIF o teléfono...',
    ...
    errors: {
      ...
      cifInvalid: 'El CIF no es válido',
      cifDuplicate: 'Ya existe un proveedor con este CIF',
    },
    actions: {
      save: 'Guardar',
      saving: 'Guardando...',
  ...
  tasks: {
    ...
    form: {
      ...
      client:            'Cliente',
      clientNone:        'Seleccionar cliente',
      sale:              'Venta',
      saleNone:          'Sin venta',
      case:              'Caso',
      caseNone:          'Sin caso',
      provider:          'Proveedor',
      providerSupplier:  'Proveedor',
